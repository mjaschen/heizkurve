#!/usr/local/Cellar/gnuplot/5.4.1_1/bin/gnuplot
#
#
#    	G N U P L O T
...
set terminal png nocrop enhanced size 2560,1440 font "/Users/mjaschen/Library/Fonts/iosevka-etoile-regular.ttf,22.0"
set output 'heizkurve.png'
...
set xlabel "Außentemperatur [℃]"
set xlabel  font "" textcolor lt -1 norotate
set x2label ""
set x2label  font "" textcolor lt -1 norotate
set xrange [ -15.0000 : 15.0000 ] noreverse writeback
set x2range [ -15.0000 : 15.0000 ] noreverse writeback
set ylabel "Vorlauftemperatur [℃]"
set ylabel  font "" textcolor lt -1 rotate
set y2label ""
set y2label  font "" textcolor lt -1 rotate
set yrange [ 22.0000 : 36.0000 ] noreverse writeback
...
a = 4
x = 0.0
## Last datafile plotted: "heizkurve.txt"
plot \
